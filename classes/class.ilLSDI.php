 ...
 */
include_once("/var/www/html/ilias/Modules/LearningSequence/classes/Visibility/class.ilLSVisibilityDB.php");
class ilLSDI extends Container
{
    public function init(ArrayAccess $dic)
    {
        ...
        $this["db.visibility"] = function ($c) use ($dic) : ilLSVisibilityDB {
            return new ilLSVisibilityDB($dic["ilDB"]);
        };
