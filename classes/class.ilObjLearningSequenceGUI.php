 ...
 */
include_once("/var/www/html/ilias/Modules/LearningSequence/classes/class.ilObjectLPAddNewItemGUI.php");
class ilObjLearningSequenceGUI extends ilContainerGUI
{
    ...
    public function showPossibleSubObjects()
    {
        ...
        $gui = new ilObjectLPAddNewItemGUI($this->object->getRefId());
        $gui->render();
    }
