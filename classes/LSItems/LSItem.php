...
class LSItem
{
    ...
    public function getVisibility() : ilLSVisibility
    {
        return $this->visibility;
    }

    public function withVisibility(ilLSVisibility $postcondition) : LSItem
    {
        $clone = clone $this;
        $clone->visibility = $postcondition;
        return $clone;
    }
}
