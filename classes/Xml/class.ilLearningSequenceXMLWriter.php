...
class ilLearningSequenceXMLWriter extends ilXmlWriter
{
    ...
    protected function writeLSItems()
    {
        ...
        foreach ($ls_items as $ls_item) {
            ...
            $visbility = $ls_item->getVisibility();
            ...
            $this->xmlElement("ls_item_vis_vis_operator", null, $visbility->getVisibilityOperator());
            $this->xmlElement("ls_item_vis_vis_pre", null, $visbility->getPre());
            $this->xmlElement("ls_item_vis_vis_type", null, $visbility->getVis());
