...
class ilObjLearningSequenceLearnerGUI
{
    ...
    {
        //Vorbereiten der zu renderten Seite
        $response = $this->player->play($_GET, $_POST);

        switch ($response) {
            case null:
                //rendern der vorgefertigten Seite
                $this->tpl->enableDragDropFileUpload(null);
                //Nachricht, welche nur im Plugin zu sehen ist dass das Weiterleiten nicht funktioniert hat
